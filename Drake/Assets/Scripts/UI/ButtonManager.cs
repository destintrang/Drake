...
public class ButtonManager : MonoBehaviour
{
    ...
    private void ResetSelector()
    {
        ...
        optionIndex = 0;
        selector.localPosition = new Vector3(options[optionIndex].localPosition.x - 70, options[optionIndex].localPosition.y, options[optionIndex].localPosition.z);
